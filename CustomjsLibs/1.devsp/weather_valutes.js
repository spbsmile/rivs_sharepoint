$(document).ready(function () {
	...
	$("#spbDegreesDuplicat_View").text($('#' + unicId + '_ctl00_spbDegreesDuplicat').text());
	...
	$("#uchalyWeatherDegrees_View").text($('#' + unicId + '_ctl00_uchalyDegrees').text());
	...
	$("#kentayWeatherDegrees_View").text($('#' + unicId + '_ctl00_kentayDegrees').text());
	...
	$("#magnitogorskWeatherDegrees_View").text($('#' + unicId + '_ctl00_magnitogorskDegrees').text());

	//for modal window
	$("#modalWeatherSpbDescription").text($('#' + unicId + '_ctl00_spbDescriptionDuplicat').text());
	$("#modalWeatherSpbDegrees").text($('#' + unicId + '_ctl00_spbDegreesDuplicat').text());

	$("#modalWeatherUchalyDescription").text($('#' + unicId + '_ctl00_uchalyDescription').text());
	$("#modalWeatherUchalyDegrees").text($('#' + unicId + '_ctl00_uchalyDegrees').text());

	$("#modalWeatherErdenetDescription").text($('#' + unicId + '_ctl00_erdenetDescription').text());
	$("#modalWeatherErdenetDegrees").text($('#' + unicId + '_ctl00_erdenetGegrees').text());

	$("#modalWeatherMscDescription").text($('#' + unicId + '_ctl00_mscDescription').text());
	$("#modalWeatherMscDegrees").text($('#' + unicId + '_ctl00_mscDegrees').text());

	$("#modalWeatherErevanDescription").text($('#' + unicId + '_ctl00_erevanDescription').text());
	$("#modalWeatherErevanDegrees").text($('#' + unicId + '_ctl00_erevanDegrees').text());

	$("#modalWeatherTachkentDescription").text($('#' + unicId + '_ctl00_tashkentDescription').text());
	$("#modalWeatherTachkentDegress").text($('#' + unicId + '_ctl00_tashkentDergrees').text());

	$("#modalWeatherKentayDescription").text($('#' + unicId + '_ctl00_kentayDescription').text());
	$("#modalWeatherKentayDegress").text($('#' + unicId + '_ctl00_kentayDegrees').text());

	$("#modalWeatherMgnDescription").text($('#' + unicId + '_ctl00_magnitogorskDescription').text());
	$("#modalWeatherMgnDegrees").text($('#' + unicId + '_ctl00_magnitogorskDegrees').text());
