// этот скрипт был скачан с офицального сайта решений ms sp, для решения проблемы появления хлебных крошек в библиотеках документы 
...
function folderNavigation() {
    function onPostRender(renderCtx) {
        if (renderCtx.rootFolder) {
            ...
            var rootNavItem =
                {
                    title: useDocLibTitleAsRootFolderName ? renderCtx.ListTitle : "Главная",
