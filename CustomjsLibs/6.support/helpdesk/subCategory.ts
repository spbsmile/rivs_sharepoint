...
let subcategory = {
	'1': [{
		...
		tip: 'Некоторые программы вы можете установить самостоятельно. Инструкция, как это сделать, находится в нашей базе знаний&nbsp' + '<a href="file://server-sc/IT/Самостоятельная%20установка%20ПО.docx">/server-sc/IT/Самостоятельная установка ПО.docx</a>'
	}, {
			main: "Обновить ПО",
